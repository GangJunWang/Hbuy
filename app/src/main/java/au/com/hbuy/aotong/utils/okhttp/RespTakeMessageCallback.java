 ...
 */
public abstract class RespTakeMessageCallback<T> extends Callback<RespInform<T>> {
    private Gson gson;
    private Activity mContext;
    private String mSaveName;
    private CustomProgressDialog dialog;
    public RespTakeMessageCallback(Activity context, String saveName) {
    ...
    public RespTakeMessageCallback(Activity context, String saveName, CustomProgressDialog dialog) {
        this.dialog = dialog;
        GsonBuilder builder = new GsonBuilder();
        gson = builder.create();
        this.mContext = context;
